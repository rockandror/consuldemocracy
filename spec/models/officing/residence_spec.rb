...
describe Officing::Residence do
  ...
  describe "validations" do
    ...
    describe "allowed age" do
      it "is not valid if user is under allowed age", :broken do
      ...
      it "is valid if user is above allowed age", :broken do
  ...
  describe "save" do
    ...
    it "stores document number, document type, geozone, date of birth and gender", :broken do
      residence.save
      user = residence.user
    ...
    it "finds existing user and use demographic information", :broken do
    ...
    it "makes half-verified users fully verified", :broken do
