...
describe Verification::Residents::Import do
  ...
  context "#save" do
    ...
    it "Add successfully created verification residents to created_records array" do
      ...
      expect(import.created_records.collect{|record| record.data["document_number"]}).to eq(valid_document_numbers)
    end

    it "Add invalid (suplicated) verification residents to invalid_records array" do
