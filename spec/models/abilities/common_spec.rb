...
describe Abilities::Common do
  ...
  describe "when level 2 verified" do
    ...
    describe "Poll" do
      ...
      it { should     be_able_to(:prioritize_answers, poll_question_from_own_geozone)   }
      it { should     be_able_to(:prioritize_answers, poll_question_from_all_geozones)  }
      it { should_not be_able_to(:prioritize_answers, poll_question_from_other_geozone) }

      it { should_not be_able_to(:prioritize_answers, expired_poll_question_from_own_geozone)   }
      it { should_not be_able_to(:prioritize_answers, expired_poll_question_from_all_geozones)  }
      it { should_not be_able_to(:prioritize_answers, expired_poll_question_from_other_geozone) }
