shared_examples "document validations" do |documentable_factory|
  ...
  let!(:maxfilesize)            { documentable_max_file_size(document.documentable.class) }
  let!(:acceptedcontenttypes)   { documentable_accepted_content_types(document.documentable.class) }
