module Users
  def sign_up(email = 'manuela@consul.dev', password = "Judgementday1234")
    visit root_path
  ...
  def login_through_form_with_email_and_password(email='manuela@consul.dev', password="Judgementday1234")
    visit root_path
    click_link 'Sign in'
