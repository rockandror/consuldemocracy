  ...
  context 'Setting social media meta tags' do
    ...
    scenario 'Social media meta tags partial render settings content' do
      ...
      expect(page).to have_meta "twitter:image",
        with:"http://www.example.com#{Rails.application.config.relative_url_root}/social_media_icon_twitter.png"
      ...
      expect(page).to have_property "article:author", with: 'https://www.facebook.com/' +
                                                             facebook_handle
      expect(page).to have_property "og:url", with: "http://www.example.com#{Rails.application.config.relative_url_root}/"
      expect(page).to have_property "og:image", with: "http://www.example.com#{Rails.application.config.relative_url_root}/social_media_icon.png"
