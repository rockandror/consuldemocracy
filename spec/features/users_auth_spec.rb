...
feature 'Users' do
  ...
  context 'Regular authentication' do
    context 'Sign up' do
      ...
      scenario 'Success' do
        ...
        fill_in "user_password",              with: "Judgementday1234"
        fill_in "user_password_confirmation", with: "Judgementday1234"
    ...
    context 'Sign in' do
      ...
      scenario 'sign in with email' do
        create(:user, email: "manuela@consul.dev", password: "Judgementday1234")
      ...
      scenario "resets failed attempts after successful login", :js do
        user = create(:user, email: "manuela@consul.dev",
                             password: "Judgementday1234",
                             failed_attempts: 3)
        visit user_session_path

        fill_in "Email or username", with: "manuela@consul.dev"
        fill_in "Password", with: "Judgementday1234"
      ...
      scenario "shows recaptcha only after consecutive failed attempts", :js do
        create(:user, email: "manuela@consul.dev", password: "Judgementday1234", failed_attempts: 0)
      ...
      scenario "unchecked recaptcha with correct login details", :js do
        ...
        create(:user, email: "manuela@consul.dev", password: "Judgementday1234", failed_attempts: 1)
  ...
  context 'OAuth authentication' do
    context 'Twitter' do
      ...
      scenario 'Sign in, user was already signed up with OAuth' do
        user = create(:user, email: "manuela@consul.dev", password: "Judgementday1234")
      ...
      scenario 'Try to register with the username of an already existing user' do
        create(:user, username: "manuela", email: "manuela@consul.dev", password: "Judgementday1234")
        OmniAuth.config.add_mock(:twitter, twitter_hash_with_verified_email)
  ...
  scenario 'Admin with password expired trying to use same password', :broken do
    user = create(:user, password_changed_at: Time.current - 1.year, password: "Admin123456789")
    admin = create(:administrator, user: user)
