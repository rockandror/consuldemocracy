...
describe "Admin wizards verification field assignments" do
  let!(:fake_handler) do
  ...
  describe "Index" do
    scenario "Should show defined verification fields" do
      ...
      visit admin_wizards_verification_field_assignments_path("fake_handler")
  ...
  describe "Create" do
    scenario "Should show successful notice after creating a new field" do
      visit new_admin_wizards_verification_field_assignment_path("fake_handler")
    ...
    scenario "Should show validation errors alert and message after submitting
      ...
      message = "1 error prevented this Verification/Field/Assignment from being saved."
    ...
    scenario "Should show format field when selected field is a date", :js do
      ...
      create(:verification_field_assignment, verification_field: text_field, handler: fake_handler.id)
      create(:verification_field_assignment, verification_field: date_field, handler: fake_handler.id)
      visit new_admin_wizards_verification_field_assignment_path("fake_handler")
  ...
  describe "Update" do
    scenario "Should show successful notice after creating a new field" do
      field_assignment = create(:verification_field_assignment, verification_field: field,
                                                                        handler: fake_handler.id)
      create(:verification_field, label: "Phone", name: "phone", position: 2)
      visit edit_admin_wizards_verification_field_assignment_path("fake_handler", field_assignment)
  ...
  describe "Edit" do
    scenario "Should show request and response path fields when handler is remote census", :js do
      ...
      create(:verification_field, label: "Phone", name: "phone", position: 2)
      visit edit_admin_wizards_verification_field_assignment_path("remote_census", field_assignment)
