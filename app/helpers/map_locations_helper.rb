  ...
  private
    ...
    def prepare_map_settings(map_location, editable, parent_class, investments_coordinates = nil)
      options = {
        ...
        map_gesture_handling_scroll: t("map.gesture.handling.scroll"),
        map_gesture_handling_scrollmac: t("map.gesture.handling.scrollmac"),
        map_gesture_handling_touch: t("map.gesture.handling.touch"),
