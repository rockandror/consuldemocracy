module DocumentablesHelper
  ...
  def documentable_max_file_size(documentable_class)
    document_bytes_to_mega(documentable_class.max_file_size)
  end

  def documentable_accepted_content_types(documentable_class)
    documentable_class.accepted_content_types
  end

  def documentable_accepted_content_types_extensions(documentable_class)
    documentable_class.accepted_content_types
  ...
  def documentables_note(documentable)
    t "documents.form.note", max_documents_allowed: max_documents_allowed(documentable),
                             ...
                             max_file_size: documentable_max_file_size(documentable.class)
  end
