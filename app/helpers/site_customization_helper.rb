module SiteCustomizationHelper
  ...
  def information_texts_tabs
    [:basic, :debates, :community, :proposals, :polls, :layouts, :mailers, :management, :welcome, :annotator, :devise_views, :budgets, :dashboard, :legislation, :devise, :account, :application, :comments, :comments_helper, :errors, :form, :geozones, :notifications, :map, :poll_questions, :proposal_notifications, :shared, :unauthorized, :users, :votes, :admin, :related_content]
  end
end
