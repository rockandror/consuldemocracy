class Officing::Residence
  ...
  private
    ...
    def retrieve_census_data
      @census_api_response = CensusCaller.new.call(document_type, document_number, date_of_birth, postal_code)
    end
    ...
    def valid_year_of_birth?
      return true if calculate_presence_date_of_birth?
