module CommentableActions
  ...
  def index
    ...
    @remote_translations = detect_remote_translations(@resources, parse_featured_resources)
  end
  ...
  private
    ...
    def parse_featured_resources
      @featured_proposals.present? ? @featured_proposals : []
    end
