...
if Administrator.count == 0 && !Rails.env.test?
  admin = User.create!(username: "admin", email: "admin@consul.dev", password: "Admin12345678", password_confirmation: "Admin12345678", confirmed_at: Time.current, terms_of_service: "1")
