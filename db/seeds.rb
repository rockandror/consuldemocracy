...
if Administrator.count == 0 && !Rails.env.test?
  admin = User.create!(username: "admin", email: "admin@consul.dev", password: "Admin1234", password_confirmation: "Admin1234", confirmed_at: Time.current, terms_of_service: "1")
