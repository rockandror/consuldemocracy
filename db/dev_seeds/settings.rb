section "Creating Settings" do
  ...
  Setting.create(key: "remote_census.general.endpoint", value: "census_api_endpoint")
  Setting.create(key: "remote_census.request.method_name", value: "get_habita_datos")
  Setting.create(key: "remote_census.request.structure", value: "{ request: { codigo_institucion: 1, codigo_portal: 1, codigo_usuario: 1, documento: 'xxx', tipo_documento: 'xxx', codigo_idioma: '102', nivel: '3' } }")
  Setting.create(key: "remote_census.request.alias_document_type", value: "request.tipo_documento")
  Setting.create(key: "remote_census.request.alias_document_number", value: "request.documento")
  ...
  Setting.create(key: "remote_census.response.date_of_birth", value: "get_habita_datos_response.get_habita_datos_return.datos_habitante.item.fecha_nacimiento_string")
  Setting.create(key: "remote_census.response.postal_code", value: "get_habita_datos_response.get_habita_datos_return.datos_vivienda.item.codigo_postal")
  Setting.create(key: "remote_census.response.district", value: "get_habita_datos_response.get_habita_datos_return.datos_vivienda.item.codigo_distrito")
  Setting.create(key: "remote_census.response.gender", value: "get_habita_datos_response.get_habita_datos_return.datos_habitante.item.descripcion_sexo")
  Setting.create(key: "remote_census.response.name", value: "get_habita_datos_response.get_habita_datos_return.datos_habitante.item.nombre")
  Setting.create(key: "remote_census.response.surname", value: "get_habita_datos_response.get_habita_datos_return.datos_habitante.item.apellido1")
  Setting.create(key: "remote_census.response.valid", value: "get_habita_datos_response.get_habita_datos_return.datos_habitante.item")
end
