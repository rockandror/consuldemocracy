section "Creating Settings" do
  ...
  Setting.create(key: "remote_census.request.structure", value: "{ request: { tipo_documento: , documento: , codigo_institucion: 12 } }")
  Setting.create(key: "remote_census.request.alias_document_type", value: "tipo_documento")
  Setting.create(key: "remote_census.request.alias_document_number", value: "documento")
  ...
  Setting.create(key: "remote_census.response.date_of_birth", value: "[:datos_habitante][:item][:fecha_nacimiento_string]")
  Setting.create(key: "remote_census.response.postal_code", value: "[:datos_vivienda][:item][:codigo_postal]")
  Setting.create(key: "remote_census.response.district", value: "[:datos_vivienda][:item][:codigo_distrito]")
  Setting.create(key: "remote_census.response.gender", value: "[:datos_habitante][:item][:descripcion_sexo]")
  Setting.create(key: "remote_census.response.name", value: "[:datos_habitante][:item][:nombre]")
  Setting.create(key: "remote_census.response.surname", value: "[:datos_habitante][:item][:apellido1]")
  Setting.create(key: "remote_census.response.valid", value: "[:datos_habitante][:item]")
end
