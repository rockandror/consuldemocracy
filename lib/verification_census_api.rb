class VerificationCensusApi
  ...
  private
    ...
    def stubbed_response(attributes)
      ...
      elsif (attributes[:document_number] == "00000000Z" || attributes[:document_number] == "00000000Y") && attributes[:document_type] == "1"
        stubbed_valid_response_without_min_age_required
      else
    ...
    def stubbed_valid_response_without_min_age_required
      {
        get_habita_datos_response: {
          get_habita_datos_return: {
            datos_habitante: {
              item: {
                fecha_nacimiento_string: "31-12-2010",
                identificador_documento: "00000000Z",
                descripcion_sexo: "Varón",
                nombre: "José",
                apellido1: "García"
              }
